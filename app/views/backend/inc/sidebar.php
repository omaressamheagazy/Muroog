      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <li>
              <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#second-layout">
                <span class="me-3">
                ...
                <div class="collapse" id="second-layout">
                  <ul class="navbar-nav ps-3">
                    <li>
                      <a href="/admin/all" class="nav-link px-3">
                        <span class="me-2">
                    ...
                    <li>
                      <a href="/admin/add" class="nav-link px-3">
                        <span class="me-2">
            ...
            <!-- third item -->
            <li>
              <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#third-layout">
              ...
              <div class="collapse" id="third-layout">
                <ul class="navbar-nav ps-3">
                  ...
                  <li>
                    <a href="/admin/building/add" class="nav-link px-3">
                      <span class="me-2">
            ...
            <!-- fourth item -->
            <li>
              <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#fourth-layout">
                <span class="me-3">
            ...
            <!-- fifth item -->
            <li>
              <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#fifth-layout">
                <span class="me-3">
